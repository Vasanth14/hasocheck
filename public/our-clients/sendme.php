...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'vijaymathimayandi78@gmail.com'; // Replace with your Gmail email
        $mail->Password   = 'qfupjjjivpjftush'; // Replace with your Gmail password
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;

        $mail->setFrom($email, $name);
        $mail->addAddress('vjmathi78@gmail.com', 'Recipient Name'); // Replace with the recipient's email and name
